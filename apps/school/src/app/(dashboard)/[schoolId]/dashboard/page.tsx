    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="border-border shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Recouvrement Total</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-foreground">{formatCurrency(FAKE_METRICS.totalCollection)}</div>
        ...
        <Card className="border-border shadow-sm">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground">{FAKE_METRICS.collectionRate}%</div>
        ...
        <Card className="border-border shadow-sm">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground">{formatCurrency(FAKE_METRICS.remainingAmount)}</div>
          </CardContent>
        </Card>
        
        <Card className="border-border shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Élèves à Jour</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-foreground">{FAKE_METRICS.studentsUpToDate} <span className="text-lg text-muted-foreground font-normal">/ {FAKE_METRICS.totalStudents}</span></div>
            <p className="text-xs text-muted-foreground mt-1">80% de la totalité</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <Card className="border-border shadow-sm h-full">
            <CardHeader className="pb-4">
              <CardTitle className="text-base font-semibold text-foreground">Derniers Encaissements</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                ...
                <TableBody>
                  {FAKE_RECENT_PAYMENTS.map((txn) => (
                    <TableRow key={txn.id}>
                      <TableCell className="font-medium text-foreground">{txn.student}</TableCell>
                      <TableCell className="text-muted-foreground">{txn.class}</TableCell>
                      ...
                      <TableCell className="text-muted-foreground text-sm">{txn.receipt}</TableCell>
                      <TableCell>
        ...
        <div>
          <Card className="border-border shadow-sm h-full">
            <CardHeader className="pb-4">
              <CardTitle className="text-base font-semibold text-foreground">Activité Caisse en Direct</CardTitle>
            </CardHeader>
            <CardContent>
